...
HMC5883L_T g_tMag_Stk[5];
struct hmc5883l_info HMC5883L_H;
struct hmc5883l_correct_info H5853_C; //HMC5883修正数据
uint8_t HMC5883LFlag = 0;
/*
*********************************************************************************************************
...
void HMC5883L_DataDeal(void)
{
	HMC5883L_T g_tMag_Temp;

	Mem_Set(&g_tMag_Temp, 0x00, sizeof(HMC5883L_T));
	
	g_tMag_Stk[0] = g_tMag_Stk[1];
	g_tMag_Stk[1] = g_tMag_Stk[2];
	g_tMag_Stk[2] = g_tMag_Stk[3];
	g_tMag_Stk[3] = g_tMag_Stk[4];
	g_tMag_Stk[4] = g_tMag;
	
	g_tMag_Temp.X = g_tMag_Stk[0].X + g_tMag_Stk[1].X + g_tMag_Stk[2].X + g_tMag_Stk[3].X + g_tMag_Stk[4].X;
	g_tMag_Temp.Y = g_tMag_Stk[0].Y + g_tMag_Stk[1].Y + g_tMag_Stk[2].Y + g_tMag_Stk[3].Y + g_tMag_Stk[4].Y;
	g_tMag_Temp.Z = g_tMag_Stk[0].Z + g_tMag_Stk[1].Z + g_tMag_Stk[2].Z + g_tMag_Stk[3].Z + g_tMag_Stk[4].Z;	
	
	HMC5883L_H.X = (g_tMag_Temp.X / 5.0) * H5853_C.Mag_X_k + H5853_C.Mag_X_b;
	HMC5883L_H.Y = (g_tMag_Temp.Y / 5.0) * H5853_C.Mag_Y_k + H5853_C.Mag_Y_b;
	HMC5883L_H.Z = (g_tMag_Temp.Z / 5.0) * H5853_C.Mag_Z_k + H5853_C.Mag_Z_b;
